<?php
/**
 * TOP API: qimen.taobao.crm.season.list.get request
 * 
 * @author auto create
 * @since 1.0, 2018.12.28
 */
class TaobaoCrmSeasonListGetRequest
{
	/** 
	...
	/** 
	 * 支持的传入字段 season_code,season_name,season_note,lastchanged
	 **/
	private $fields;
	...
	{
		return "qimen.taobao.crm.season.list.get";
	}
