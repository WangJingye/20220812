<?php
/**
 * TOP API: qimen.taobao.crm.brand.list.get request
 * 
 * @author auto create
 * @since 1.0, 2018.12.28
 */
class TaobaoCrmBrandListGetRequest
{
	/** 
	...
	/** 
	 * 支持的传入字段 brand_code,brand_name,brand_desc,lastchanged
	 **/
	private $fields;
	...
	{
		return "qimen.taobao.crm.brand.list.get";
	}
