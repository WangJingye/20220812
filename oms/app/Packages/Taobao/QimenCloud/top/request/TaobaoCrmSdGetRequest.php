<?php
/**
 * TOP API: qimen.taobao.crm.sd.get request
 * 
 * @author auto create
 * @since 1.0, 2018.12.28
 */
class TaobaoCrmSdGetRequest
{
	/** 
	...
	public function setSddm($sddm)
	{
		$this->sddm = $sddm;
		$this->apiParas["sddm"] = $sddm;
	}

	public function getSddm()
	{
		return $this->sddm;
	}
	...
	{
		return "qimen.taobao.crm.sd.get";
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMaxLength($this->sddm,64,"sddm");
