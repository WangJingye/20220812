<?php
/**
 * TOP API: qimen.taobao.crm.size.list.get request
 * 
 * @author auto create
 * @since 1.0, 2018.12.28
 */
class TaobaoCrmSizeListGetRequest
{
	/** 
	...
	/** 
	 * 支持的传入字段 size_code,size_name,size_note,lastchanged
	 **/
	private $fields;
	...
	{
		return "qimen.taobao.crm.size.list.get";
	}
