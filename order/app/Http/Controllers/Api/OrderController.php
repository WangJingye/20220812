...
class OrderController extends ApiController
{
    ...
    public function saveRefundInfo(SaveRefundInfoRequest $request){
        ...
        $this->dispatch(new \App\Jobs\UpdateRefund($order_id,[
    ...
    public function orderShip(Request $request){
        ...
        $this->dispatch(new \App\Jobs\ShipOrderAfter($params));
        //发货通知
        $this->dispatch(new \App\Jobs\OrderNotify('orderShipped',$request->get('orderId')));
        return $this->success();
    }
     ...
     * @return array
     */
    public function orderReturnAllow(Request $request){
        //通知
        $this->dispatch(new \App\Jobs\OrderNotify('orderReturnAllow',['orderId'=>$request->get('orderId')]));
        return $this->success();
    }
    ...
    public function orderRefunded(Request $request){
        //通知
        $this->dispatch(new \App\Jobs\OrderNotify('orderRefunded',['orderId'=>$request->get('orderId')]));
        return $this->success();
    }
