<template>
    <div class="multi_image">
        ...
        <div class="">
            <el-upload
                    v-if="currentElement.nodes==false || currentElement.nodes.length <28"
                    ref="upload"
                    class="upload-image"
            ...
            <div class="form-group">
                    <el-form-item label="列数" >
                        <div class="">
                            <el-input-number v-model="currentElement.columns" label="列" :min="1" :max="3" size="mini"></el-input-number>
                        </div>
                    </el-form-item>
            </div>
