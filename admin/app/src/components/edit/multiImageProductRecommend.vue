            ...
            <div class="form-group">
                <template v-if="['pc','h5'].includes($root.$data.mediaType)">
                    <el-form-item label="列数/pc" >
                        <div class="">
                            <el-input-number v-model="currentElement.columns.pc" label="列" :min="2" :max="10" size="mini"></el-input-number>
                        </div>
                    </el-form-item>
                    <el-form-item label="列数/h5" >
                        <div class="">
                            <el-input-number v-model="currentElement.columns.h5" label="列" :min="1" :max="10" size="mini"></el-input-number>
                        </div>
                    </el-form-item>
                </template>
                            ...
                            if(response.status==true){
                                ...
                                self.currentElement.nodes.push( {
                                    ...
                                    src:{
                                        ...
                                        h5:self.getOssImage() + response.file
                                    },
                                    'action':{
                                        data:{},
                                        type:'none',
