<template>
    <div class="multi_image_product">
        ...
        <div class="">
            ...
            <el-form-item label="页码TOP">
                    <div class="">
                        <el-input-number v-model="currentElement.top"  :min="1" :max="100" size="mini"></el-input-number>%
                    </div>
            </el-form-item>
            <el-form-item label="页码LEFT">
                <div class="">
                    <el-input-number v-model="currentElement.left"  :min="1" :max="100" size="mini"></el-input-number>%
                </div>
            </el-form-item>
