...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/static/admin/css/collect.css') }}" media="all">
</head>
<body class="layui-layout-body">
<style>
dd>a{text-indent:12px;}
/*dd.layui-this a{color:blue !important;}*/
</style>
<div id="LAY_app">
                    ...
                    @foreach($menus as $menu)
                        @can($menu['permission']?:null)
                            <li data-name="{{$menu['name']}}" class="layui-nav-item">
                                <a href="javascript:;" @if(!empty($menu['route']))lay-href="{{ route($menu['route']) }}"@endif lay-tips="{{$menu['display_name']}}" lay-direction="2">
...
<script src="{{ url('/static/admin/js/collect.js') }}"></script>
