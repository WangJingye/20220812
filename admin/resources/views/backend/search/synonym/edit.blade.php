                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width: 500px">
                        <input class="layui-input" type="text" name="convert_word" lay-verify="required"
                               placeholder=""  value="{{$detail->convert_word}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width: 500px">
                        <input class="layui-input" type="text" name="remark" lay-verify="required"
                               placeholder=""  value="{{$detail->remark}}">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form'], function () {
        form.on('submit(confirm)', function (data) {
            $.post("{{ route('backend.goods.search.updateSynonym') }}", data.field, function (res) {
                if (res.code === 1) {
                    layer.msg('操作成功', {
                        icon: 1,
                        shade: 0.3,
