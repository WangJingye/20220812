        ...
        <div class="layui-card">
            <div class="layui-card-body" style="padding: 15px;">
                <form id="add_form" class="layui-form" action="">
                    ...
                    @isset($detail['getType']['is_cut'])
                    <div class="layui-form-item">
                        <label class="layui-form-label">类型</label>
                        <div class="layui-input-block">
                            <select name="type_list" lay-filter="type_list" >
                            	<option {{'full_reduction_of_order'==$detail['getType']['type']?'selected':''}} value="full_reduction_of_order">满减</option>
                            	<option {{'order_n_discount'==$detail['getType']['type']?'selected':''}} value="order_n_discount">每满减</option>
                            </select>
                        </div>
                    </div>
                    @endif
                    ...
                    @if($detail['getType']['type'] == 'product_discount' or  $detail['getType']['type'] == 'n_piece_n_discount' or $detail['getType']['type'] == 'product_coupon')
                        <div class="layui-form-item">
                    ...
                    @if($detail['getType']['type'] == 'ship_fee_try')
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="ship_fee" lay-verify="required|int" placeholder="付邮运费" value="{{$detail['ship_fee']??''}}" autocomplete="off" class="layui-input" type="text">
                            </div>
                        </div>
                    @endif
...
{{--                        <div class="layui-form-item">--}}
{{--                            <label class="layui-form-label">随单礼券图片oss路径</label>--}}
{{--                            <div class="layui-input-block">--}}
{{--                                <input name="product_coupon_pic" lay-verify="required" value="{{$detail['product_coupon_pic']??''}}" autocomplete="off"--}}
{{--                                       class="layui-input" type="text">--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="layui-form-item">--}}
...
{{--                            <div class="layui-input-block">--}}
{{--                                <input name="product_coupon_name" lay-verify="required" value="{{$detail['product_coupon_name']??''}}" autocomplete="off"--}}
{{--                                       class="layui-input" type="text">--}}
{{--                            </div>--}}
{{--                        </div>--}}
                        @isset($detail['coupon_stock_used'])
                    ...
                    <div class="layui-form-item {{$detail['getType']['type'] == 'ship_fee_try'?'layui-hide':''}}">
                        ...
                        <div id="rule" class="layui-inline">
                            ...
                            @endif
                                @if($detail['getType']['type'] == 'product_coupon')
                                    <div class="layui-input-inline">
                                        <input class="layui-input" lay-verify="required" name="product_coupon_sku" placeholder="实物sku" value="{{$detail['product_coupon_sku']??''}}" type="text">
                                    </div>
                                @endif
                    ...
                    @if($detail['getType']['type'] == 'gift')
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input name="is_rand" type="hidden" value="0">
                                <input name="is_rand" title="选择" @if(!empty($detail['is_rand'])) checked="" @endif type="checkbox" value="1">
                            </div>
                        </div>
                    @endif
                    @if($detail['getType']['type'] == 'free_try')
                    ...
                    <div class="layui-form-item {{$detail['getType']['type'] == 'ship_fee_try'?'layui-hide':''}} ">
                        ...
                        <div class="layui-input-block" id="div-addloading">
                            <div class="layui-btn layui-btn-primary" id="addloading">点击加载<br/></div>
                        </div>
                    </div>
