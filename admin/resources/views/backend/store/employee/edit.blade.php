                 ...
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="sid"
                               lay-verify="required|number" data-raw="{{$detail['sid']??old('sid')}}"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="role_name"
                               lay-verify="required" data-raw="{{$detail['role_name']??old('role_name')}}"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" type="text" name="phone"
                               lay-verify="required|phone" value="{{$detail['phone']??old('phone')}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
