...
{{--            <el-form ref="form" class="layui-form" method="post" onsubmit="return check();">--}}
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block " id="J_colle_products_chunk">
...
<script>
    ...
    layui.use(['form','upload'], function () {
        ...
        form.on('submit(confirm)', function (data) {
            $.post("{{ route('backend.goods.collection.insert') }}", data.field, function (res) {
                if (res.code === 1) {
                    layer.msg('操作成功', {
                        icon: 1,
                        shade: 0.3,
    ...
    table.on('tool(list)', function(obj){
        ...
        if(obj.event === 'select'){
            ...
            //
            //
            // alert('ID：'+ data.usage_code + ' 的查看操作');
