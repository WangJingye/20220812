...
<div id="app" class="page-content-wrap">
    ...
    <div>
        ...
        <el-form ref="form" id="cms-form"  method="post" action="{{url('admin/goods/sku/cmssave')}}" enctype="multipart/form-data" label-width="80px">
            ...
            <div class="layui-tab" style="margin: 0;display: none;">
                            ...
                            <div class="layui-tab-item layui-show">
                                <div class="content">
                                    <custom-clone v-if="true"
                                                  ...
                                                  :title="title"
                                                  :use_tags="['image','video','multi_image','product_detail_multi_part_text','product_detail_title_desc','product_detail_text','product_recommend']"
                                    ></custom-clone>
                                </div>
                            </div>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="小程序" name="wechat" v-if="true">
                        <?php //内容部分?>
                        <div class="layui-tab-content">
                            <div class="layui-tab-item"></div>
                            <div class="layui-tab-item layui-show">
...
<script>
    $(window).scroll( function() {
        ...
        if(scrollTop > 220){
            ...
            $('.edit-wrap').removeClass('edit-wrap-scroll').css('top',420 - scrollTop);
            $('.element-list-wrap').removeClass('edit-wrap-scroll-menu').css('top',420 - scrollTop);
