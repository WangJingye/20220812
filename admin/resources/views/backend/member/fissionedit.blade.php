                ...
                <div class="layui-form-item " id="condition_value" style="">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="">
                                <input class="layui-input" lay-verify="gift" id="condition_value" name="condition_value" placeholder="人" value="" type="text">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="layui-input-block">
                            <div  class="layui-input-inline" >
                                <select lay-verify="gwp" name="step" >
                                    ...
                                    <option value="1">送一件</option>
                                    <option value="2">送多件</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item" id="div_gwp_multiple" style="">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input-inline" style="">
                                <input class="layui-input" lay-verify="max_num" id="max_num" name="max_num" placeholder="人" value="" type="text">（多少人才能获得权益）
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
