                ...
                <div class="layui-form-item">
                 ...
                 <div class="layui-form-item">
                        ...
                        <div id="rule" class="layui-inline">
                            ...
                            @isset($detail['condition_value'])
                            @foreach($detail['condition_value'] as $k=>$n)
                            @if($k != 0)
                            <div class="add_more_product"><hr style="background-color:transparent;">
                            <div class="layui-input-inline">
                                <input class="layui-input" lay-verify="required|number|int_percent" name="condition_value[{{$k}}]" placeholder="满X人" value="{{$detail['condition_value'][$k]??''}}" type="text">
                            </div>
                            <div class="layui-input-inline">
                                <input class="layui-input" lay-verify="required|number|int_percent|css_bigger_ten" name="value_id[{{$k}}]" placeholder="促销规则优惠券id" value="{{$detail['value_id'][$k]??''}}" type="text">
                            </div>
                ...
                <!--div class="layui-form-item" id="div_gwp_multiple" style="">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-input-inline" style="">
                            <input class="layui-input" lay-verify="max_num" id="max_num" name="max_num" placeholder="人" value="{{$detail['max_num']}}" type="text">
                        </div>
                    </div>
                </div-->
                <div class="layui-form-item">
